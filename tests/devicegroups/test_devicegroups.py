...
from soti_mobicontrol_python.endpoints.devicegroups.get_devicegroups import get_devicegroup_with_parrent, get_all_devicegroups
...
async def test_get_device_group_with_parrent():
    ...
    # Get the test parameters from the config
    test_parameters = config.get_test_parameters()
    device_group_path = test_parameters['deviceGroupPaths'][0]
